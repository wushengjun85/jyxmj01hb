...
/************************************************************************************************/
    ...
    if(flagBattery) //闪烁
    {
        ...
        paintBattery.drawPixmap(51,0,43,34,pixBattery);//正上方图片显示

        paintBattery.drawPixmap(20,335,43,34,pixBattery);//左边图片显示
    }
    ...
    if(flagSW) //闪烁
    {
        ...
        paintSW.drawPixmap(204,0,35,35,pixSW);//正上方位置显示的图标
    ...
    //机油  油压报警 0～1 MPa,在0.1 MPa 以下为报警区。
    ...
    if(flagJY) //闪烁
    {
        ...
        paintJY.drawPixmap(306,0,43,43,pixJY);//正上方位置显示的图标

        paintJY.drawPixmap(20,180,43,43,pixJY);//左边显示的图标
...
//    }
    ...
    if(flagyouxiangman|flagyouliangdi)
    {
        ...
        paintYL.drawPixmap(20,120,43,43,pixYL);
    }
